(function($) {   
	...
	function renderpager(pagenumber, pagecount, buttonClickCallback) {        // setup $pager to hold render     
		...
		var strgoto = $("<li class='thpoint'>当前<input type='text' value='"+pagenumber+"'maxlength='6' id='gotoval' style='width:15px; height:14px; margin-top:-4px; padding-top:2px; padding-left:5px;'/>页</li>");
