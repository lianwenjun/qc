...
<script type="text/javascript" src="{{ asset('/evolve/js/admin/pages/ads/draft-edit.js') }}"></script>
    ...
    <div class="breadcrumb">
        ...
        <div class="content"> 
            ...
            <!-- <form name="form" action="" method="get" class="validate jq-form"> -->
                {{ Form::open(['url'=>URL::route('topics.create'), 'method'=>'post', 'class' => 'validate jq-form']) }}
                ...
                <table cellpadding="0" cellspacing="0" class="edit-zebra-table">
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <input type="text" placeholder="请输入......" class="input label-content" name="title" />
                            </td>
                        </tr>
                        <tr>
