                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="javascript:;" class="button @if($data->status == 'unstock') disabled @endif" data-url="">下架</a>
                            @endif
                            @if(Sentry::getUser()->hasAccess('topics.edit'))
                            <a href="javascript:;" class="button @if($data->status == 'unstock') disabled @endif">编辑</a>
                            @endif
                            @if(Sentry::getUser()->hasAccess('topics.delete'))
                            <a href="javascript:;" class="button red-button jq-delete @if($data->status == 'stock') disabled @endif" data-url="">删除</a>
                            @endif
                        </td>               
                    </tr>
                    @empty
