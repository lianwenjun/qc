        ...
        <div class="content"> 
            ...
            <form name="form" action="" method="get" class="validate jq-form">
                ...
                <table cellpadding="0" cellspacing="0" class="edit-zebra-table">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $datas['banner']->id }}</td>
                        </tr>
                        <tr>
                            <td class="label">游戏名称：</td>
                            <td>{{ $datas['banner']->title }}</td>
                        </tr>
                        <tr>
                            <td class="label">包名：</td>
                            <td>{{ $datas['banner']->pagage }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" placeholder="例：1" class="input" name="sort" value="{{ $datas['banner']->sort }}"/>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" class="input jq-startime" name="stocked_at" /> 到 <input type="text" class="input jq-endtime" name="unstocked_at"  />
                ...
                <p class="inline-button">
                    ...
                    <a href="{{ URL::route('banners.index') }}" class="button">返回列表</a>
                </p>
            </form>
            <!-- /表单 -->
        </div>
