                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td><select class="Search_select" name="location">
                            ...
                            <input id="autocomplete" type="text" class="Search_text jq-searchapps" value="" placeholder="应用名称输入时自动匹配" style="width:25%" />　或　从最近新增的游戏添加　<a href="#" class="Search_Update">选择</a></td>
                    </tr>
