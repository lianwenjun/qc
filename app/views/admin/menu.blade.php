...
<div class="Content_left">
      <ul>
            ...
            @if( Sentry::check() )
            <li class="Content_left_title">Hi，{{ Sentry::getUser()->username }}<br><a href="<?php echo URL::route('users.changePwd'); ?>" target=BoardRight>修改密码</a>　<a href="<?php echo URL::route('users.signout') ?>" target="_top">退出系统</a></li>
            @endif
      </ul>
</div>
