   ...
   <div class="Search_biao">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
         ...
         <tr class="Search_biao_{{ $k%2 == 0 ? 'one' : 'two'}}">
            ...
            <td><a href="{{ URL::route('apps.dooffshelf', ['id' => $app['id']]) }}" class="Search_show jq-dooffshelf">下架</a> <a href="{{ URL::route('apps.edit', ['id' => $app['id'] ]) }}" target="BoardRight" class="Search_show">编辑</a> <a href="{{ URL::route('apps.history', ['id' => $app['id'] ]) }}" target="BoardRight" class="Search_show">编辑</a> </td>
         </tr>
         @endforeach
         @if(empty($apps['total']))
